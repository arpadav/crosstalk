...
//     pub1_topic4.write(message2.clone());
...
//     thread::spawn(move || {
//         let subscriber = test_node.subscriber(TopicZoo::Topic4).unwrap();
//         let received: Option<HashMap<&str, Vec<Vehicle>>> = subscriber.read_blocking();
//         println!("{:?}", received);
//         let received2 = subscriber.read();
//         println!("{:?}", received2);
//     }).join().unwrap();
// }
